...
<div class="preloader">
  ...
  <div class="col">
	...
	<br>
    <input class=" form-control-sm col-7" id="dateRangePicker" name="dateRangePicker" type="text" />
	</div>
  <div class="col">
  <label for="userTypeFilter">Estado:</label>
  <br>
	<select class=" form-select-sm col-7"  id="userTypeFilter">
  ...
  <br>
	<select  class="form-select-sm col-7"  id="Prioridad">
	<option value="" selected>Selecciona una opcion</option>
